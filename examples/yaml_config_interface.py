...
class ConfigurableAgent(dacp.Agent):
    ...
    def _handle_capability(self, capability: Dict[str, Any], message: Dict[str, Any]) -> Dict[str, Any]:
        """
...
def main():
    ...
    try:
        ...
        test_messages = [
            ...
            {"task": "generate_report", "subject": "User Behavior Analysis", "data": "user metrics"},
    ...
    try:
        ...
        print(f"  ⚙️  Intelligence Engine: {config.get('intelligence', {}).get('engine', 'unknown')}")
