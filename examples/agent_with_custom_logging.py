...
def main():
    ...
    response = orchestrator1.send_message("env-agent", {
        "task": "greet",
    ...
    response = orchestrator2.send_message("direct-agent", {
        "task": "write_report",
        "subject": "Custom Logging Test"
    })
    print(f"Response: {response}")
    ...
    response = orchestrator3.send_message("yaml-agent", {
        "task": "greet",
        "name": "YAML User"
    })
    print(f"Response: {response}")
